(() => {
  const demos = [...document.querySelectorAll('.mymind-command-demo')];
  ...
  demos.forEach((demo) => {
    const query = demo.querySelector('.mymind-command-demo__query');
    const results = [...demo.querySelectorAll('.mymind-command-demo__result')];
    const canvas = demo.querySelector('.mymind-command-demo__orb');
    const flowNodes = [...demo.querySelectorAll('.mymind-command-demo__flow-node')];
    const flowEdges = [...demo.querySelectorAll('.mymind-command-demo__connections g')];
    const ideation = demo.querySelector('.mymind-command-demo__ideation');
    const mobileVideo = demo.querySelector('.mymind-command-demo__mobile-video');
    const perspectiveMode = demo.classList.contains('mymind-command-demo--perspective');
